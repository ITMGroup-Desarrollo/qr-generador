...
* `qr_generador` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `qr-generador` - executable or bundle name on disk.
* `qr-generador` - display name shown in window titles and about app dialogs.
